...
print("="*31)
print("| Prediksi Cuaca di Indonesia | ")
print("| Yosua Satria Bara harmoni, 21083010029   | ")
print("="*31)
...
def tampil_menu():
    print("Menu :")
    print("[1] Mengupdate data ")
    print("[2] Masukkan provinsi")
    print("[3] Masukkan kota")
    print("[4] Atur tanggal ")
    print("[5] Prediksi cuaca")
    print("[6] Memastikan data")
    print("[X] Exit")
